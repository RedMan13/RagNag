...
class RenderWebGL extends EventEmitter {
     ...
     */
    createTextCostumeSkin(textState) {
        const skinId = this._nextSkinId++;
     ...
     * @param {!object} textState the state to apply.
     */
    updateTextCostumeSkin (skinId, textState) {
        // update existing skin
        if (this._allSkins[skinId] instanceof TextCostumeSkin) {
            this._allSkins[skinId].setTextAndStyle(textState);
            return;
        }
    ...
    _drawThese (drawables, drawMode, projection, opts = {}) {
        ...
        for (let drawableIndex = 0; drawableIndex < numDrawables; ++drawableIndex) {
            ...
            const drawableScale = framebufferSpaceScaleDiffers
                ...
                : drawable.scale;
            // always flip sprites so they appear upright
            drawableScale[1] *= -1;
